...
// ============================================================================
// BDM low-level bit-bang transport (matches FUN_code_0001f9)
// ============================================================================
...
uint16_t bdm_read_word(uint32_t addr) {
    ...
    bdm_transfer(addr >> 16);
    bdm_transfer(addr & 0xFFFF);
    return bdm_transfer(0x0000);  // Dummy to clock in response
}
...
// Alias for backwards compatibility (used in rtc.c)
